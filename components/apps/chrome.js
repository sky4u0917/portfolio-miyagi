...
export class Chrome extends Component {
    ...
    componentDidMount() {
        let lastVisiharukaUrl = localStorage.getItem("chrome-url");
        let lastDisplayedUrl = localStorage.getItem("chrome-display-url");
        if (lastVisiharukaUrl !== null && lastVisiharukaUrl !== undefined) {
            this.setState({ url: lastVisiharukaUrl, display_url: lastDisplayedUrl }, this.refreshChrome);
        }
    }

    storeVisiharukaUrl = (url, display_url) => {
    ...
    checkKey = (e) => {
        if (e.key === "Enter") {
            ...
            this.storeVisiharukaUrl(url, display_url);
