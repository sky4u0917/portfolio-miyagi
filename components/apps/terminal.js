...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["nicole-personal-portfolio", "synonyms-list-react", "economist.com-unlocked", "Improve-Codeforces", "flutter-banking-app", "Meditech-Healthcare", "CPU-Scheduling-APP-React-Native"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className="text-ubt-green">nicole@ASUS</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/nicole")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemenharuka.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nicole, about-resume, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-nicole":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-nicole");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemenharuka.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nicole, about-resume, todoist, trash, settings, sendmsg ]";
                }
                break;
